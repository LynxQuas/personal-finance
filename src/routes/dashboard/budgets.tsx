          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-7">
              ...
              <SavingMicro
                ...
                limit="of $750.00"
                amount={150}
                className="flex flex-row justify-between border-l-6 border-secondary-cyan"
              />
              <SavingMicro
                title="Dining Out"
                limit="of $50.00"
                amount={15}
                className="flex flex-row justify-between border-l-6 border-secondary-yellow"
              />
              <SavingMicro
                title="Personal Care"
                limit="of $50.00"
                amount={15}
                className="flex flex-row justify-between border-l-6 border-secondary-navy"
              />
            </div>
          </div>
        </div>
